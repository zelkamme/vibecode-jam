...
from llm.tools import parse_json_list
...
def cached_chat(client, model, messages, stream=False, redis_host="redis", redis_port=6379, ttl=3600, illusion=True, use_cache=True):
