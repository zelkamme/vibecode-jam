...
def generate_qa_review(lang, question, answer, position, llm_api, redis_host="redis", redis_port=6379):
...
def test_qa_review(llm_api, redis_host="redis", redis_port=6379):
    lang = "Python"
